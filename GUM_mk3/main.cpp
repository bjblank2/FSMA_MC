...
int main(void) {
	...
	sim_cell.initSimCell(input_file, dist_list, shape, species, 1, string("DEFAULT"), string("AUST"), string("RAND"), string("ORDERED"),use_poscar);
  	cout << "Testing" << '\n';
	cout << "begining MC" << '\n';
	//runMetropolis1(10, 1, 50, 1, sim_cell, mc_rules);
	//runMetropolis2(10, 1, 50, 1, mc_rules);
	runMetropolis3(400, 1600, 10, -5, sim_cell, mc_rules);
