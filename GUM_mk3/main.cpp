...
int main(void) {
	...
	int shape[3] = { 4, 4, 8 };//{ 8,8,16 }; //{ 20,20,40 }; //{ 14,14,18 }; //{ 2,2,4 }; //{ 4,4,8 };
	int species[3] = { 64, 64, 0 };//{ 512, 384, 128 }; //{ 8000,8000,0 };   //{ 2744,2744,0 }; //{8,6,2}; //{ 64,48,16 };
	...
	cout << "begining MC" << '\n';
	runMetropolis3(100, 100, 1, 20, 1, atom_list, cluster_rules, spin_rules);
